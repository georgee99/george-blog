...
if (useDefaultHtml && !html) {
  html = [
    ...
    '          <p style="margin:0 0 16px;font-size:15px;line-height:1.6;">Hey,</p>',
    `          <p style="margin:0 0 28px;font-size:15px;line-height:1.6;">I just published a new post &mdash; come have a read.</p>`,
    `          <p style="margin:0 0 28px;">`,
    `            <a href="https://georgeelz.blog/blog/${slug}" style="display:inline-block;padding:12px 24px;background:#111111;color:#ffffff;text-decoration:none;font-size:14px;font-weight:600;letter-spacing:0.5px;">Read the post</a>`,
    '          </p>',
